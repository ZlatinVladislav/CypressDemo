...
There are examples that are part of a Continuous e2e build in the main repo, that also showcase more advanced
...
[Facebook.feature](https://github.com/TheBrainFamily/cypress-cucumber-example/blob/master/cypress/e2e/socialNetworks/Facebook.feature)
```
@feature-tag
...
[GitHub.feature](https://github.com/TheBrainFamily/cypress-cucumber-example/blob/master/cypress/e2e/socialNetworks/GitHub.feature)
```
...
The first one will include scenario tagged `@tag-to-include` from the [GitHub.feature](https://github.com/TheBrainFamily/cypress-cucumber-example/blob/master/cypress/e2e/socialNetworks/GitHub.feature), while 
